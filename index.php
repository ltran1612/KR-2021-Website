            ...
            <div class="card card-5 m-t-30-pc">
                ...
                <div class="card-body">
                        <div class="kr-edit m-b-10">
                            You can edit your participation and opt out answer <a href="php/edit_login.php" target="_blank">here</a>.
                        </div>
                        <!--STARTING THE FORM-->
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="col-1">
                                    <div class="input-group-desc">
                                        <input class="input--style-5" type="tel" placeholder="Ex: 1 575 111" pattern="[0-9 ]+" name="phone_number">
