                        ...
                        <div class="form-row hide">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input value="" class="input--style-5" type="email" name="email_address" value=<?php echo $email?>>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="p-t-15">
                                ...
                                <div class="p-t-20">
                                    ...
                                    <div class="value">
                                        <div class="input-group">
                                            <input class="input--style-5" placeholder="Ex: representation1;representation2" type="text" name="videos_not_to_publish" value=<?php echo "";?>>
