                ...
                <div class="card-body">
                    ...
                    <?php
                        if ($success) {
                            ...
                            echo " You can edit your participation answer and videos to not publish after conference using the registered email address <a href=\"./edit_login.php\" target=\"_blank\">here</a>.<br>";
                        } // END IF
